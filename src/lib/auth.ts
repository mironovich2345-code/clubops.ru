...
const ROLE_PAGE_ACCESS: Record<Role, ReadonlyArray<AppPage>> = {
  owner: ["dashboard", "analytics", "ofd_sales", "expenses", "collections", "invoices", "payments", "mandatory_payments", "balances", "employees", "payroll", "refunds", "budgets", "sales", "activity", "users", "settings"],
  ...
  general_director: ["dashboard", "analytics", "ofd_sales", "expenses", "collections", "invoices", "payments", "mandatory_payments", "balances", "employees", "payroll", "sales", "budgets", "activity", "users", "settings"],
  regional_director: ["dashboard", "analytics", "ofd_sales", "expenses", "collections", "invoices", "payments", "mandatory_payments", "balances", "employees", "payroll", "refunds", "budgets", "sales", "documents", "activity", "users"],
  // Manager: operational, own-club only. No network analytics financials and no
  // audit/activity log.
  manager: ["dashboard", "analytics", "expenses", "collections", "invoices", "employees", "payroll", "refunds", "budgets", "sales", "documents"],
  ...
  accountant: ["workspace", "expenses", "collections", "invoices", "payments", "mandatory_payments", "balances", "employees", "payroll", "refunds", "budgets", "sales", "documents", "activity"],
  ...
  chief_accountant: ["workspace", "expenses", "collections", "invoices", "payments", "mandatory_payments", "balances", "employees", "payroll", "refunds", "budgets", "sales", "documents", "activity"],
