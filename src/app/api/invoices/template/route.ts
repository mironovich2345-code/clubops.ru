...
export async function GET() {
  ...
  const example = [
    ...
    25000,
    "Хозрасходы",
    "2026-06", // Период расхода — месяц, к которому относится расход (если пусто — берётся из даты счёта)
    "2026-06-15",
    "", // Дата оплаты — заполните, чтобы импортировать как оплаченный счёт
    "Поставка инвентаря",
  ];
