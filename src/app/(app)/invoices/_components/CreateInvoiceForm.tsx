...
export function CreateInvoiceForm({ clubs }: { clubs: ClubOption[] }) {
  ...
  return (
    <div>
      <div className="mb-4 flex justify-end">
        ...
        >
          {open ? "Скрыть форму" : "Добавить счёт"}
        </button>
      </div>
      ...
      {open ? (
        ...
        >
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <Field label="Контрагент" error={fe.counterpartyName}>
              <input
            ...
            <Field label="Назначение" error={fe.subject}>
              <input
                name="subject"
                required
            ...
            <Field label="Дата счёта" error={fe.invoiceDate}>
              <input
                type="date"
                name="invoiceDate"
            ...
            <Field label="Срок оплаты" error={fe.dueDate}>
              <input
                type="date"
                name="dueDate"
                required
