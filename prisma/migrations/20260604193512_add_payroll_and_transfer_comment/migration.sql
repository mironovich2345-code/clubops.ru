...
CREATE TABLE "PayrollStatement" (
    ...
    CONSTRAINT "PayrollStatement_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "PayrollStatement_clubId_fkey" FOREIGN KEY ("clubId") REFERENCES "Club" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "PayrollStatement_createdByUserId_fkey" FOREIGN KEY ("createdByUserId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "PayrollStatementRow" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "PayrollStatementRow_payrollStatementId_fkey" FOREIGN KEY ("payrollStatementId") REFERENCES "PayrollStatement" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
