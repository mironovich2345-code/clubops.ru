-- Non-destructive additive migration (production PostgreSQL) — STAGE 13 OFD cashier →
-- employee attribution. New nullable columns + three tables. No ALTER TYPE, no rebuild,
-- no recompute. Existing receipts read operator* as NULL → cashier unmatched.
...
ALTER TABLE "PayrollCalculation" ADD COLUMN "salesSyncedAt" TIMESTAMP(3);
...
CREATE TABLE "OfdCashierIdentity" (
    ...
    CONSTRAINT "OfdCashierIdentity_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "OfdCashierMapping" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    CONSTRAINT "OfdCashierMapping_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "PayrollSalesAttribution" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    CONSTRAINT "PayrollSalesAttribution_pkey" PRIMARY KEY ("id")
);
