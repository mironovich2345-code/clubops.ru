...
-- AddForeignKey
ALTER TABLE "CashNotification" ADD CONSTRAINT "CashNotification_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;
