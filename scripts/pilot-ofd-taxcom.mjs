...
async function main() {
  ...
  check("AUDIT-REFUND-POLICY2 result formula не менялась (ofdNet − confirmedCosts)", mgmtLib.includes("return ofdNetKopeks - confirmedCostsKopeks") && analyticsPage.includes("computeManagementResult(ofd!.totals.netKopeks, s.expensesKopeks)") && dashPage.includes("computeManagementResult(ofdMgmt?.totals.netKopeks ?? 0, s.expensesKopeks)"));
